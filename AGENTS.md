...
- Token aktif mengikuti redesign T31 yang disetujui: cream `#FFF5E3`, surface `#FFFFFF`, primary `#A6412D`, coral `#ED896F`, mint `#7CD3AA`, kuning `#F2C879`, ink `#303044`, muted `#686472`, dan border kontrol `#81796E`. `app/static/css/tailwind.input.css` menjadi sumber token.
- Gunakan Plus Jakarta Sans dan ikon lokal. Ilustrasi custom sekitar 5–7 aset, konsisten bergaya editorial 2D cream/coral/mint/kuning, tanpa glossy 3D; gunakan pada konteks yang ditetapkan di `UX-CONTRACT.md`.
